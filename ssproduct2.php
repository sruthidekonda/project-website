...
<body>
    ...
    <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
              <form action="cart.php" method="post"><img src="image/product/2.jpg" weight=100%   id="MainImg" alt=""> </form>
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="image/product/2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/4.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/5.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/6.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
        ...
        <form action="cart.php" method="POST">
            <div class="single-pro-details">
                ...
                <input type="hidden" name="item_name" value="Design Flounce Gown">
                <input type="hidden" name="price" value="1800">
            <h4>Product Details</h4>
            <span>Look flat-out fabulous at a Saturday evening party with this stunning 
                shimmering dress for women from AND. Crafted from textured silver and 
                black fabric flaunting a sleeveless bodice, V-neckline and an elongated 
                layered flare. Stylise this dress with long dangling earrings and heels.</span>
        </div>
    </section>
