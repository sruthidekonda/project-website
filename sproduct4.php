...
<body>
    ...
    <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
              <form action="cart.php" method="post"><img src="image/home/4.jpg" weight=100%   id="MainImg" alt=""> </form>
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="image/home/4.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/14.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/15.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/16.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
        ...
        <form action="cart.php" method="POST">
            <div class="single-pro-details">
                ...
                <span>A printed festive kurta with a round neckline and embroidery detailing. It comes with 
                    tassel tie-ups on both sides to accentuate the waistline. Style it with a pair of 
                    beige or gold palazzos and earrings to complete the look.</span>
            </div>
        </form>
    </section>
