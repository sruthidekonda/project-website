   ...
   <section id="header">
    ...
    <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
              <form action="cart.php" method="post"><img src="image/home/7.jpg" weight=100%   id="MainImg" alt=""> </form>
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="image/home/7.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/21.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/22.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/23.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
        ...
        <form action="cart.php" method="POST">
            <div class="single-pro-details">
                ...
                <input type="hidden" name="item_name" value="Floral Flared Suit">
                <input type="hidden" name="price" value="1800">
                <h4>Product Details</h4>
                <span>Imbued with immense femininity is this gorgeous set for women from 
                    Global Desi. Crafted from plush fabrics, this print-on-print set 
                    comprises a fit and flare midi-length tiered flared dress with spaghetti 
                    straps and an embellished neckline along with an organza dupatta with 
                    scallop detail at the border. Elevate this ensemble with dangling gold 
                    earrings and embellished kolhpuris.</span>
            </div>
        </form>
    </section>
