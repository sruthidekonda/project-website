...
<body>
    ...
    <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
              <form action="cart.php" method="post"><img src="image/home/1.jpg" weight=100%   id="MainImg" alt=""> </form>
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="image/home/1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
        ...
        <form action="cart.php" method="POST">
            <div class="single-pro-details">
                ...
                <div class="dress-name">
                    <h3>Mustard Ethnic Motifs Flared Skirt</h3>
                </div>
                <div class="price">
                    <h2>RS-2700</h2>
                </div>
                ...
                <input type="hidden" name="item_name" value="Mustard Ethnic Motifs Flared Skirt">
                <input type="hidden" name="price" value="2700">
                <h4>Product Details</h4>
                <span>Gorgeous and rich-looking ethnic skirt for women from Global Desi. Made from plush silk blend fabric, the A-line circular skirt showcases floral foil print all over. This versatile skirt can be paired with a range of ethnic blouses and short kurtas or tops. Accessorise with dangling earrings and youre going to steal the show.Occasion-Festive, Fit-Flared, Print Type-Ethnic Motifs, Product Length-Regular Length, Closure-Zip.</span>
            </div>
        </form>
    </section>
