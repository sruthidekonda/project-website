   ...
   <section id="header">
    ...
    <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <form action="cart.php" method="POST">  <img action="cart.php" method="POST" src="image/home/3.jpg" weight=100%   id="MainImg" alt=""></form>
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="image/home/3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/9.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/10.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/11.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
            <form action="cart.php" method="POST">
                <div class="single-pro-details">
                    ...
                    <div class="dress-name">
                        <h3>Mustard Floral Flared Suit</h3>
                    </div>
                    <div class="price">
                        <h2>RS-2200</h2>
                    </div>
                    ...
                    <input type="hidden" name="item_name" value="Mustard Floral Flared Suit">
                    <input type="hidden" name="price" value="2200">
                    <h4>Product Details</h4>
                    <span>Bedazzle all the eyes at the next festive or wedding party with this 
                        gorgeous two-piece set for women from Global Desi. Crafted from the 
                        finest fabric with a rogan motif print all over. This kurta set comprises 
                        a fit and flare kurta with a cross-over neckline with mirror work and tie-up 
                        in a vibrant shade of mustard. The bottom is a trendy dhoti in a complementing 
                        colour. Elevate the ensemble with ethnic Kundan and gold earrings and kolhapuri heels.</span>
                </div>
            </form>
    </section>
