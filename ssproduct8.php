...
<body>
    ...
    <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
              <form action="cart.php" method="post"><img src="image/product/8.jpg" weight=100%   id="MainImg" alt=""> </form>
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="image/product/8.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/22.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/23.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/24.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
        ...
        <form action="cart.php" method="POST">
            <div class="single-pro-details">
                ...
                <input type="hidden" name="item_name" value="Straight Jumpsuit">
                <input type="hidden" name="price" value="1200">
            <h4>Product Details</h4>
            <span>Look chic and sophisticated for the next evening soiree with this jumpsuit for women 
                from AND. Made from light fabric in a gorgeous sage green hue, this sleeveless jumpsuit 
                flaunts a crossover neckline with a fabric tie-up at the side with utilitarian pockets, 
                and long wide-leg bottom. Style this minimal jumpsuit with gold earrings and colour 
                coordinating heels.</span>
        </div>
    </section>
