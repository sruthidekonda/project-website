...
<body>
    ...
    <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
              <form action="cart.php" method="post"><img src="image/t-shirt/2.jpg" weight=100%   id="MainImg" alt=""></form>
            </div>
        ...
        <form action="cart.php" method="POST">
            <div class="single-pro-details">
                ...
                <div class="dress-name">
                    <h3>Bugs Bunny T-shirts for Girls</h3>
                </div>
                <div class="price">
                    <h2>RS-220</h2>
                </div>
                ...
                <input type="hidden" name="item_name" value="Bugs Bunny T-shirts for Girls">
                <input type="hidden" name="price" value="220">
                <h4>Product Details</h4>
                <span>Fabri:Bio-washed Cotton, Neck:Round Neck, Pattern:Printed, Sleeve:Half-sleeves, Fit:Regular-fit, Style:Casual Wear</span>
            </div>
        </form>
    </section>
