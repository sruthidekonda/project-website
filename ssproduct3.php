...
<body>
    ...
    <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
              <form action="cart.php" method="post"><img src="image/product/3.jpg" weight=100%   id="MainImg" alt=""> </form>
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="image/product/3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/7.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/8.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/9.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
        ...
        <form action="cart.php" method="POST">
            ...
            <span>A beautiful winter dress for those relaxed winter evenings. Made in a warm 
                and comfy fabric, the shift dress features long sleeves and a faux-turtle 
                neck. Front pocket detailing accentuates the overall look of the knee-length 
                dress. Style it with your boots and minimalist earrings for chic vibes.</span>
        </div>
    </section>
