   ...
   <section id="header">
    ...
    <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
              <form action="cart.php" method="post"><img src="image/home/8.jpg" weight=100%   id="MainImg" alt=""> </form>
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="image/home/8.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/29.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/30.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/32.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
        ...
        <form action="cart.php" method="POST">
            <div class="single-pro-details">
                ...
                <div class="dress-name">
                    <h3>Mustard Geometric Print Fit and Flare Jumpsuit</h3>
                </div>
                <div class="price">
                    <h2>RS-2800</h2>
                </div>
                ...
                <input type="hidden" name="item_name" value="Mustard Geometric Print Fit and Flare Jumpsuit">
                <input type="hidden" name="price" value="2800">
                <h4>Product Details</h4>
                <span>An ethnic jumpsuit for women with embellished print and three-quarter sleeves. 
                On any occasion, people will be awestruck by your elegance in this jumpsuit. 
                Pair it with beautiful ear-rings for a traditional look with a modern touch.</span>
            </div>
        </form>
    </section>
