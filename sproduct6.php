   ...
   <section id="header">
    ...
    <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
              <form action="cart.php" method="post"><img src="image/home/6.jpg" weight=100%   id="MainImg" alt=""> </form>
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="image/home/6.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/25.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/26.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/27.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
        ...
        <form action="cart.php" method="POST">
            <div class="single-pro-details">
                ...
                <div class="dress-name">
                    <h3>Embroidered V-Neck Tunic</h3>
                </div>
                <div class="price">
                    <h2>RS-3800</h2>
                </div>
                ...
                <input type="hidden" name="item_name" value="Embroidered V-Neck Tunic">
                <input type="hidden" name="price" value="3800">
                <h4>Product Details</h4>
                <span>Make a stunning style statement and mesmerise all the eyes in the room 
                    at the next festive party with this flat-out-fabulous purple kurta set 
                    for women from Global Desi. The set comprises a fit and flares long kurta 
                    with zardozi embroidery detail at the neckline in a gorgeous orange 
                    organza adorned with statement floral print. It flaunts three-fourth sleeves 
                    and a V-neckline. Elevate the ensemble with a Kundan-pearls choker, earrings, 
                    some bangles, and block-heel kolhapuris.</span>
            </div>
        </form>
    </section>
