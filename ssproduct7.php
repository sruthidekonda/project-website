...
<body>
    ...
    <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
              <form action="cart.php" method="post"><img src="image/product/7.jpg" weight=100%   id="MainImg" alt=""> </form>
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="image/product/7.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/19.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/20.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/21.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
        ...
        <form action="cart.php" method="POST">
            <div class="single-pro-details">
                ...
                <input type="hidden" name="item_name" value="Straight Top</h3>">
                <input type="hidden" name="price" value="500">
            <h4>Product Details</h4>
            <span>Elevate your workwear style quotient with this rust top for women from AND. 
                Fashioned for breathable summer material, this top features a round neck, 
                long sleeves and vertical pleat details. Complete the look with wide-leg 
                white jeans or trousers and gold earrings.</span>
        </div>
    </section>
