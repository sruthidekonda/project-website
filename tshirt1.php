...
<body>
    ...
    <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
              <form action="cart.php" method="post"><img src="image/t-shirt/1.jpg" weight=100%   id="MainImg" alt=""></form>
            </div>
        ...
        <form action="cart.php" method="POST">
            <div class="single-pro-details">
                ...
                <div class="dress-name">
                    <h3>Relax T-shirts for Girls</h3>
                </div>
                <div class="price">
                    <h2>RS-200</h2>
                </div>
                ...
                <input type="hidden" name="item_name" value="Relax T-shirts for Girls">
