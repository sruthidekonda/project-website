...
<body>
    ...
    <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
              <form action="cart.php" method="post"><img src="image/product/6.jpg" weight=100%   id="MainImg" alt=""> </form>
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="image/product/6.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/16.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/17.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/18.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
        ...
        <form action="cart.php" method="POST">
            <div class="single-pro-details">
                ...
                <input type="hidden" name="item_name" value="Stripes Cropped Set">
                <input type="hidden" name="price" value="1500">
            <h4>Product Details</h4>
            <span>Brighten up your Sunday styling game with this elegant striped co-ord set from AND 
                for women. The off-shoulder crop top features balloon three-fourth sleeves and the 
                straight trouser has a tie-up detail at the waist and utilitarian pockets. These 
                are crafted from lightweight breathable fabric. Team it up with colour coordinating 
                sandals or white sneakers and oversized golden hoops.</span>
        </div>
    </section>
