...
<body>
    ...
    <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
              <form action="cart.php" method="post"><img src="image/product/1.jpg" weight=100%   id="MainImg" alt=""> </form>
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="image/product/1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/ssproducts/3.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
        ...
        <form action="cart.php" method="POST">
            <div class="single-pro-details">
                ...
                <input type="hidden" name="item_name" value="Floral dress">
                <input type="hidden" name="price" value="1200">
                <h4>Product Details</h4>
                <span>>Get ready for that lunch with the ladies coming up this weekend with this 
                feminine and chic floral printed dress for women from AND. Made from light 
                sheer fabric with a frilled high neck in a fit and flare contour featuring 
                loose bell sleeves and an asymmetrical tier flared hemline. Stylise this 
                dress with dainty gold-finish studs and heels.</span>
            </div>
        </form>
    </section>
