   ...
   <section id="header">
    ...
    <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
              <form action="cart.php" method="post"><img src="image/home/5.jpg" weight=100%   id="MainImg" alt=""> </form>
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="image/home/5.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/17.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/18.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="image/singlepro/19.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            </div>
        ...
        <form action="cart.php" method="POST">
            <div class="single-pro-details">
                ...
                <div class="dress-name">
                    <h3>Geometric Blouson Stitched Saree</h3>
                </div>
                <div class="price">
                    <h2>RS-3500</h2>
                </div>
                ...
                <input type="hidden" name="item_name" value="Geometric Blouson Stitched Saree">
                <input type="hidden" name="price" value="3500">
                <h4>Product Details</h4>
                <span>Imbued with femininity is this saree set with a contemporary 
                    twist from Global Desi for women. This printed saree is elegant 
                    and super easy to throw on for those festive parties. The set 
                    comprises a contrasting short puffy sleeves blouse, a layer 
                    frilled long skirt and a ruffled saree pallu feet . Stylise this 
                    look with ethnic dangling earrings and juttis or heels.</span>
            </div>
        </form>
    </section>
